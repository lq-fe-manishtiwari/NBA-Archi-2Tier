...
function deleteCriteria5_6Data(id) {
  return apiNBARequest(
...
function deleteCriteria5_7Data(id) {
  return apiNBARequest(
...
function deleteCriteria5_8Data(id) {
  return apiNBARequest(
...
function deleteCriteria5_9Data(id) {
  return apiNBARequest(
