// src/screens/pages/NEWNBA/Components/GenericCriteriaForm1_2.jsx
...
const GenericCriteriaForm1_2 = (props) => {
  ...
  const [tableData, setTableData] = useState(() => {
    ...
    if (!initial["1.2.2"] || initial["1.2.2"].length === 0) {
      const field1_2_2 = props.fields?.find(f => f.name === "1.2.2");
      if (field1_2_2?.tableConfig?.presetRows) {
        initial["1.2.2"] = field1_2_2.tableConfig.presetRows.map((row, i) => ({
          ...row,
          id: `preset-1.2.2-${i}`,
          contact_hours: "",
          percentage: "",
...
export default GenericCriteriaForm1_2;