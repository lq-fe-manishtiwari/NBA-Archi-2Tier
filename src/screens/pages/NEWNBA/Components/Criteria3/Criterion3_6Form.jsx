// src/screens/pages/NEWNBA/Components/Criteria3/Criterion3_6Form.jsx
...
const Criterion3_6Form = ({
  ...
  const config = {
    title: "3.6. Evidence of Addressing Sustainable Development Goals (SDGs) ",
    totalMarks: 10,
    fields: [
      {
        name: "3.6",
        label: "Describe Student Support and Remedial Measures",
        marks: 10,
        type: "textarea",
      },
    ],
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      console.log("🟠 Criterion3_6Form - Loading data:");
      ...
      console.log("🟢 Criterion3_6Form - Raw API Response:", rawResponse);
      console.log("🟢 Criterion3_6Form - Processed Data:", d);

       setTeaching_learning_quality_id(d.teaching_learning_quality_id || null);

      setInitialData({
        content: { "3.6": d.quality_processes_description || "" },
        tableData: [],
        filesByField: {
          "3.6": (d.quality_process_documents || []).length > 0
            ...
            : [{ id: `file-3.6-0`, description: "", file: null, filename: "", s3Url: "", uploading: false }]
        }
      });

    } catch (err) {
      console.warn("❌ Criterion3_6Form - API failed or returned 404, showing blank form", err);
      setTeaching_learning_quality_id(null);
      setInitialData({
        content: { "3.6": "" },
        tableData: [],
        filesByField: {
          "3.6": [{ id: `file-3.6-0`, description: "", file: null, filename: "", s3Url: "", uploading: false }]
        }
      });
    } finally {
      setLoading(false);
  ...
  const handleSave = async (formData) => {
    ...
    try {
      ...
      const payload = {
        ...
        cycle_sub_category_id,
        quality_processes_description: formData.content["3.6"] || "",
      ...
      console.log("🟠 Criterion3_6Form - Save payload:", payload);
      ...
      setAlert(
        ...
        >
          Criterion 3.6 saved successfully
        </SweetAlert>
      );
...
export default Criterion3_6Form;