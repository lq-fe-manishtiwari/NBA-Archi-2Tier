// src/screens/pages/NEWNBA/Components/Criteria3/Criterion3_5Form.jsx
...
const Criterion3_5Form = ({
  ...
  const config = {
    ...
    fields: [
      {
        name: "3.5",
        label: "Describe Academic Performance Monitoring Process",
        marks: 20,
        type: "textarea",
      },
    ],
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      console.log("🟠 Criterion3_5Form - Loading data:");
      ...
      console.log("🟢 Criterion3_5Form - Raw API Response:", rawResponse);
      console.log("🟢 Criterion3_5Form - Processed Data:", d);

      setTeaching_learning_quality_id(d.teaching_learning_quality_id || null);

      setInitialData({
        content: { "3.5": d.quality_processes_description || "" },
        tableData: [],
        filesByField: {
          "3.5": (d.quality_process_documents || []).length > 0
            ...
            : [{ id: `file-3.5-0`, description: "", file: null, filename: "", s3Url: "", uploading: false }]
        }
      });

    } catch (err) {
      console.warn("❌ Criterion3_5Form - API failed or returned 404, showing blank form", err);
      setTeaching_learning_quality_id(null);
      setInitialData({
        content: { "3.5": "" },
        tableData: [],
        filesByField: {
          "3.5": [{ id: `file-3.5-0`, description: "", file: null, filename: "", s3Url: "", uploading: false }]
        }
      });
    } finally {
      setLoading(false);
  ...
  const handleSave = async (formData) => {
    ...
    try {
      ...
      const payload = {
        ...
        cycle_sub_category_id,
        quality_processes_description: formData.content["3.5"] || "",
      ...
      console.log("🟠 Criterion3_5Form - Save payload:", payload);
      ...
      setAlert(
        ...
        >
          Criterion 3.5 saved successfully
        </SweetAlert>
      );
...
export default Criterion3_5Form;