// src/screens/pages/NEWNBA/Components/Criteria3/Criterion3_4Form.jsx
...
const Criterion3_4Form = ({
  ...
  const config = {
    title: "3.4. Evaluation of Industrial Training/ Internship (Continuous and SEE) ",
    totalMarks: 10,
    fields: [
      {
        name: "3.4",
        label: "Describe Student Feedback and Evaluation Process",
        marks: 10,
        type: "textarea",
      },
    ],
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      console.log("🟠 Criterion3_4Form - Loading data:");
      ...
      console.log("🟢 Criterion3_4Form - Raw API Response:", rawResponse);
      console.log("🟢 Criterion3_4Form - Processed Data:", d);

setTeaching_learning_quality_id(d.teaching_learning_quality_id || null);

      setInitialData({
        content: { "3.4": d.quality_processes_description || "" },
        tableData: [],
        filesByField: {
          "3.4": (d.quality_process_documents || []).length > 0
            ...
            : [{ id: `file-3.4-0`, description: "", file: null, filename: "", s3Url: "", uploading: false }]
        }
      });

    } catch (err) {
      console.warn("❌ Criterion3_4Form - API failed or returned 404, showing blank form", err);
      setTeaching_learning_quality_id(null);
      setInitialData({
        content: { "3.4": "" },
        tableData: [],
        filesByField: {
          "3.4": [{ id: `file-3.4-0`, description: "", file: null, filename: "", s3Url: "", uploading: false }]
        }
      });
    } finally {
      setLoading(false);
  ...
  const handleSave = async (formData) => {
    ...
    try {
      ...
      const payload = {
        ...
        cycle_sub_category_id,
        quality_processes_description: formData.content["3.4"] || "",
      ...
      console.log("🟠 Criterion3_4Form - Save payload:", payload);
      ...
      setAlert(
        ...
        >
          Criterion 3.4 saved successfully
        </SweetAlert>
      );
...
export default Criterion3_4Form;