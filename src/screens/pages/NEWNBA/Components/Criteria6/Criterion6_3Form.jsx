...
const Criterion6_3Form = ({
  ...
  const loadData = async () => {
    ...
    console.log("🟠 Criterion6_3Form - useEffect triggered:");
    console.log("  - cycle_sub_category_id:", cycle_sub_category_id);
    console.log("  - currentOtherStaffId:", currentOtherStaffId);

    if (!cycle_sub_category_id) {
      console.log("❌ Criterion6_3Form: cycle_sub_category_id is missing, exiting");
      setLoading(false);
      return;
    }
    ...
    console.log("✅ Criterion6_3Form: Data loaded and set successfully");
    setLoading(false);
  };
  ...
  const handleSave = async (formData) => {
    ...
    console.log("🟠 Criterion6_3Form handleSave called");
    setSaving(true);
