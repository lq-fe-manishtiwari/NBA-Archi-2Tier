...
const Criterion6_4Form = ({
  ...
  const handleSave = async (formData) => {
    ...
    const payload = {
      ...
      museum_info: formData.content.museum_info,
      total_marks: totalMarks,
      total_collections: museumData.length,
      // Include file handling as needed
    };

    try {
      // Save API call
      // await newnbaCriteria1Service.saveCriteria6_4_Data(payload);
      toast.success("Criterion 6.4 data saved successfully!");
