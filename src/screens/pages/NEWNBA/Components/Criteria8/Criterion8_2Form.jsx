...
const Criterion8_2Form = ({
  ...
  const processData = (data) => {
    ...
    setInitialData({
      content: {
        "8.2.1": data.student_support_description || ""
      },
  ...
  const loadEmptyForm = () => {
    setInitialData({
      content: { "8.2.1": "" },
      tableData: emptyTableData,
      filesByField: { "8.2.1": [createEmptyFile()] }
    });
    setCurrentId(null);
  ...
  const createEmptyFile = () => ({
    ...
    s3Url: "",
    uploading: false,
    category: fieldName === "8.2.1" ? "Student Support Documents" : "Student Support Documents"
  });
  ...
  const handleSave = async (data) => {
    ...
    try {
      ...
      const payload = {
        ...
        student_support_description: data.content?.["8.2.1"] || "",
